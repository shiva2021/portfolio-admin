<template>
  <nav
    class="navbar nav-background-color"
    role="navigation"
    ...
    <div id="navbarBasicExample" class="navbar-menu">
      <div class="navbar-end mr-4">
        <div data-target="apps" class="navbar-item has-dropdown is-hoverable">
          <a class="navbar-link" v-if="!currentApp"> Application </a>
        ...
        <div data-target="logout" class="navbar-item has-dropdown is-hoverable">
          <a class="navbar-link">
            <div class="is-flex mt-2">
              <figure v-if="user.profile_pic" class="image is-24x24 mr-2">
                <img
                  alt="No Image Found"
                  class="is-rounded"
                  :src="user.profile_pic | AWS"
                />
              </figure>
              {{ user.fullname }}
            </div>
